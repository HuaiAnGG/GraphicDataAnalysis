...
namespace GraphicDataAnalysis
{
    class GrapContract : IGrape
    {
        ...
        #region 多条折线图
        public void InitMultBasicLineChart()
        {
        ...
        #region 垂直条形图
        public void InitBasicColumnChart()
        {
        ...
        #region 单条折线图
        public void InitSingleBasicLineChart()
        {
